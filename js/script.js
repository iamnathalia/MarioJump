...
// quando adicionada qlqr tecla, será executada a função jump e adicionar (const jump -> marioclass.list) 
// quando a função terminar, sera "removida" para que possa iniciar novamente.
